...
| **Notifications** | Reword any message. **Try typing a dose or a diagnosis into one** — it is refused when you save it, not when it is sent (spec §60). All 21 messages have a producer as of Phase 11; the screen marks any that does not, and none does                                                                                                          |

...
const ALLOWED = new Set([
  ...
  'WAITING_FOR_PATIENT>PATIENT_JOINED',
  'WAITING_FOR_PATIENT>EXPIRED',
  'WAITING_FOR_PATIENT>CANCELLED',
  'WAITING_FOR_PATIENT>REFUND_REQUESTED',
  'PATIENT_JOINED>WAITING_FOR_DOCTOR',
  'PATIENT_JOINED>CANCELLED',
  'PATIENT_JOINED>REFUND_REQUESTED',
  'PATIENT_JOINED>ABANDONED',
  'WAITING_FOR_DOCTOR>ASSIGNED',
  'WAITING_FOR_DOCTOR>CANCELLED',
  'WAITING_FOR_DOCTOR>REFUND_REQUESTED',
  'WAITING_FOR_DOCTOR>ABANDONED',
  'ASSIGNED>DOCTOR_ACCEPTED',
  'ASSIGNED>REASSIGNING',
  'ASSIGNED>CANCELLED',
  'REASSIGNING>ASSIGNED',
  'REASSIGNING>WAITING_FOR_DOCTOR',
  'REASSIGNING>CANCELLED',
  'DOCTOR_ACCEPTED>IN_PROGRESS',
  'DOCTOR_ACCEPTED>REASSIGNING',
  'DOCTOR_ACCEPTED>ABANDONED',
  'IN_PROGRESS>COMPLETING',
  'IN_PROGRESS>ABANDONED',
  'COMPLETING>COMPLETED',
  'REFUND_REQUESTED>REFUNDED',
  'REFUND_REQUESTED>ACTIVATED',
  'REFUND_REQUESTED>WAITING_FOR_PATIENT',
  'REFUND_REQUESTED>PATIENT_JOINED',
  'REFUND_REQUESTED>WAITING_FOR_DOCTOR',
  ...
  'REFUND_REQUESTED>EXPIRED',
  'REFUND_REQUESTED>CANCELLED',
  'REFUND_REQUESTED>ABANDONED',

...
describe('doctor state machine', () => {
  ...
  it('refuses every transition not in the table', () => {
    const allowed = new Set([
      ...
      'UNDER_REVIEW>APPROVED', 'UNDER_REVIEW>REJECTED', 'UNDER_REVIEW>PENDING',
      'APPROVED>ACTIVE', 'APPROVED>SUSPENDED', 'APPROVED>REJECTED',
      'ACTIVE>SUSPENDED', 'ACTIVE>EXPIRED',
      'SUSPENDED>ACTIVE', 'SUSPENDED>EXPIRED', 'SUSPENDED>REJECTED',
      'EXPIRED>UNDER_REVIEW', 'EXPIRED>SUSPENDED',
...
describe('pharmacy state machine', () => {
  ...
  it('refuses every transition not in the table', () => {
    const allowed = new Set([
      ...
      'APPROVED>ACTIVE', 'APPROVED>SUSPENDED', 'APPROVED>REJECTED',
      'ACTIVE>SUSPENDED',
      'SUSPENDED>ACTIVE', 'SUSPENDED>REJECTED',
      'REJECTED>UNDER_REVIEW',
    ]);
